...
class _StationInfoWidgetState extends State<StationInfoWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(alignment: const Alignment(1, 1), children: [
        Column(
            ...
            ? Align(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (facilitiesJP.isNotEmpty && facilitiesName.isNotEmpty) {
